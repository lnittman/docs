...
### /user:create
Initializes complete project ecosystems with four repositories:
- `[project]-xyz` - Turborepo web platform
- `[project]-ai` - Mastra AI service
- `[project]-apple` - Native iOS/macOS app
- `[project]-docs` - AI-optimized documentation
...
3. **Optional** (<80%) - Available when appropriate
