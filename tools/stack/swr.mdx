...
- [Advanced Usage](https://swr.vercel.app/docs/advanced/cache)
...
- [Prefetching](https://swr.vercel.app/docs/prefetching)

### Integration Guides
- [Next.js SSR/SSG](https://swr.vercel.app/docs/with-nextjs)
- [React Native](https://swr.vercel.app/docs/data-fetching#react-native)
- [GraphQL](https://swr.vercel.app/docs/data-fetching#graphql)

### Examples
- [SWR Examples](https://github.com/vercel/swr/tree/main/examples)
- [Optimistic UI](https://github.com/vercel/swr/tree/main/examples/optimistic-ui)
- [Infinite Loading](https://github.com/vercel/swr/tree/main/examples/infinite-scroll)