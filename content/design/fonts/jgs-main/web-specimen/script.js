...
function responsive_font() {
  ...
  /*if (height > width) {*/
  if (height < 400 || width < 560) {
    jgs5.click();
    x1.click();
  } else if ((height >= 400 && height < 560) || (width >= 560 && width < 720)) {
    jgs7.click();
    x1.click();
  } else if ((height >= 560 && height < 720) || (width >= 720 && width < 800)) {
    jgs9.click();
    x1.click();
  } else if (
    ...
    (height >= 800 && height < 1120) ||
    (width >= 1120 && width < 1200)
  ) {
    jgs7.click();
    x2.click();
  } else if (
    (height >= 1120 && height < 1200) ||
    (width >= 1200 && width < 1440)
  ) {
    jgs5.click();
    x3.click();
  } else if (
    (height >= 1200 && height < 1440) ||
    (width >= 1440 && width < 1680)
  ) {
    jgs9.click();
    x2.click();
  } else if (
    (height >= 1440 && height < 1680) ||
...
const ascii_holders = document.getElementsByClassName('ascii');

for (let i = 0; i < ascii_holders.length; i++) {
