...
description: Techniques and patterns for effective prompt design
---
...
<CardGroup cols={2}>
  <Card title="Generate a prompt" icon="link" href="https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/prompt-generator">
  ...
  <Card title="Apply XML tags" icon="link" href="https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/use-xml-tags">
...
<CardGroup cols={3}>
  <Card title="Prompt library" icon="link" href="https://docs.anthropic.com/en/resources/prompt-library/library">
...
<CardGroup>
  ...
  <Card title="Extended thinking guide" icon="code" href="https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking">
