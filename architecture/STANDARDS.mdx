...
A product must be organized into a primary web monorepo and standalone service directories:

- `[product-name]-xyz/`: The web platform, managed as a Turborepo monorepo with pnpm
- `[product-name]-ai/`: The AI service, managed as a standalone Node.js/TypeScript project
...
```
[projectName]-docs/
├── .docindex.json           # Machine-readable index for AI navigation
...
│   ├── development/
│   └── setup/
├── operations/            # DevOps and maintenance procedures
...
[projectName]-xyz/
├── apps/
│   ├── app/              # Main Next.js user-facing application
│   └── api/              # Optional API service for webhooks/cron
├── packages/
│   ├── analytics/        # PostHog wrapper
│   ├── api/              # Business logic and domain services
│   ├── auth/             # Clerk authentication wrapper
│   ├── cache/            # Redis/caching utilities
│   ├── database/         # Prisma client and schema
│   ├── design/           # UI components and design system
│   ├── email/            # React Email templates (if needed)
│   ├── github/           # GitHub integration
│   ├── logger/           # Structured logging
│   ├── mastra/           # AI service client wrapper
...
│       │       ├── instructions.xml  # Structured prompts
...
│   ├── Design/           # SwiftUI design system
│   ├── [Name]Networking/ # API client
│   └── Analytics/        # Event tracking
├── [projectName]-ios/     # Main iOS app
│   ├── Assets.xcassets/
│   ├── Resources/
│   │   └── Fonts/
│   ├── Views/            # SwiftUI views
