...
#### General Rules
- **product_layout.md** - Repository naming and organization ([product]-xyz/-ai/-apple/-docs)
...
- **turborepo_monorepo_structure.md** - apps/ and packages/ organization
...
- **Optional**: Patterns with less than 80% adoption (e.g., logger package)
