...
export const MenuTrigger = React.forwardRef<
  ...
  MenuTriggerProps
>(({ className, ...props }, ref) => (
  <BaseMenu.Trigger className={cn(className)} ref={ref} {...props} />
));
...
export const MenuBackdrop = React.forwardRef<HTMLDivElement, MenuBackdropProps>(
  ({ className, ...props }, ref) => (
    <BaseMenu.Backdrop className={cn(className)} ref={ref} {...props} />
  )
);
...
export const MenuPositioner = React.forwardRef<
  ...
  MenuPositionerProps
>(({ className, ...props }, ref) => (
  <BaseMenu.Positioner className={cn(className)} ref={ref} {...props} />
));
...
export const MenuPopup = React.forwardRef<HTMLDivElement, MenuPopupProps>(
  ({ className, ...props }, ref) => (
    <BaseMenu.Popup className={cn(className)} ref={ref} {...props} />
  )
);
...
export const MenuItem = React.forwardRef<HTMLDivElement, MenuItemProps>(
  ({ className, ...props }, ref) => (
    <BaseMenu.Item className={cn(className)} ref={ref} {...props} />
  )
);
...
export const MenuSeparator = React.forwardRef<
  ...
  MenuSeparatorProps
>(({ className, ...props }, ref) => (
  <BaseMenu.Separator className={cn(className)} ref={ref} {...props} />
));
